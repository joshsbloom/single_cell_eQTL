...
#v=Gcor[row(Gcor)==(col(Gcor)-100)]


# prune correlated markers 
...
is.expressed20=readRDS('/data/single_cell_eQTL/elegans/results/20200201/expressed_in_20_cells_broad_tissue.RDS')
...
for(kk in 1:19) { 
    ...
    # tcPsig=tissueQTLPeaksNB[[uc]]

    qm=na.omit(tcPsig[ tcPsig$FDR<.05,])
    ggplot(qm,aes(x=pos,y=tpos,alpha=-log10(FDR+1e-10)))+geom_point()+
...
#saveRDS(perTissueList, "/data/single_cell_eQTL/elegans/results/20200201/perTissueList.RDS")


#saveRDS(LODmatrix , "/data/single_cell_eQTL/elegans/results/20200201/LODS.RDS") 
#saveRDS(LPmatrix, "/data/single_cell_eQTL/elegans/results/20200201/LODS_5perms.RDS") 
...
dir.create('/data/single_cell_eQTL/elegans/results/20200201/')
#sapply(jPs, function(x) min(x$LOD))
cPs=rbindlist(jointCis,idcol='ntissues')
saveRDS(cPs, '/data/single_cell_eQTL/elegans/results/20200201/jointModel_cisOnly.RDS')
...
saveRDS(cisResults, '/data/single_cell_eQTL/elegans/results/20200201/perTissue_cisOnly.RDS') 

jPs=rbindlist(jointPeaks,idcol='ntissues')
saveRDS(jPs, '/data/single_cell_eQTL/elegans/results/20200201/jointModel_globalPeaks.RDS')

saveRDS(tissueQTLPeaksNB, '/data/single_cell_eQTL/elegans/results/20200201/perTissue_globalPeaks.RDS')

jointHotspots=getHotspots(jPs, gmapd, fdr.thresh=.2)
saveRDS(jointHotspots, '/data/single_cell_eQTL/elegans/results/20200201/jointModel_hotspots.RDS')

wthl=lapply(tissueQTLPeaksNB, function(x) {
           getHotspots(x, gmapd, fdr.thresh=.2) })
saveRDS(wthl, '/data/single_cell_eQTL/elegans/results/20200201/perTissue_hotspots.RDS')
...
saveRDS(cisResultsFine, '/data/single_cell_eQTL/elegans/results/20200201/perFineTissue_cisOnly.RDS') #jointModel_globalPeaks.RDS')
