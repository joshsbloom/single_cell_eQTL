...
#cell.cycle.classification.dir='results/cell_cycle/yeast_cc_annotations_v4/'
...
for(ee in 1:length(experiments)){
    ...
    plot(m.granges$gcoord, colSums(vg[classification,]-1)/sum(classification), ylim=c(0,1), xlab='mpos', ylab='af')
    ...
    counts=counts[,cell.covariates$barcode]
    vg=vg[cell.covariates$barcode,]
